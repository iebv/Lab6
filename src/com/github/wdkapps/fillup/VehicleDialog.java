...
public class VehicleDialog {
	...
	public static Dialog create(
		...
		final EditText textVehicleBrand = (EditText)dialog.findViewById(R.id.textVehicleBrand);
		final EditText textVehiclePlate = (EditText)dialog.findViewById(R.id.textVehiclePlate);
		final EditText textVehicleType = (EditText)dialog.findViewById(R.id.textVehicleType);
